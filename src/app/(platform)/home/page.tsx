        ...
        <div className="container mx-auto py-8">
            ...
            <div className="mb-8">
                ...
                <p className="text-muted-foreground text-lg">
                    Manage your company&apos;s equity and investments in one
                    place
                </p>
            </div>
            ...
            <div className="mt-12">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Latest updates from your cap table
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        John Doe joined as an individual
                                        investor
                                    </p>
                                </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Series A funding round successfully
                                        closed
                                    </p>
                                </div>
                                <div className="text-sm text-muted-foreground">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        SAFE agreement added for TechCorp Inc.
                                    </p>
                                </div>
                                <div className="text-sm text-muted-foreground">
                                    2d ago
