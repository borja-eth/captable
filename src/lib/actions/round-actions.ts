 ...
 * Lists all rounds
 */
export const listRoundsAction = authAction
    .metadata({
...
export const listRoundsByCompanyAction = authAction
    ...
    .action(async ({ parsedInput }) => {
        return await listRoundsByCompany(parsedInput.companyId);
    });
...
export const getRoundByIdAction = authAction
    ...
    .action(async ({ parsedInput }) => {
        return await getRoundById(parsedInput.id);
    });
...
export const createRoundAction = authAction
    ...
    .schema(roundSchema)
    .action(async ({ parsedInput }) => {
        return await createRound(parsedInput);
    });
...
export const deleteRoundAction = authAction
    ...
    .schema(z.object({ id: z.string() }))
    .action(async ({ parsedInput }) => {
        return await deleteRound(parsedInput.id);
    });
